                            ...
                            <div className="space-y-4 mb-6">
                                ...
                                <div className="grid grid-cols-2 gap-4">
                                    {(event.regular_capacity > 0 || event.regular_price > 0) && (
                                        ...
                                        >
                                            ...
                                            <div className="text-primary-900 font-bold">{event.regular_price} Birr</div>
                                        </div>
                                    )}
                                    ...
                                    {(event.vip_capacity > 0 || event.vip_price > 0) && (
                                        ...
                                        >
                                            ...
                                            <div className="text-amber-600 font-bold">{event.vip_price} Birr</div>
                                        </div>
                                    )}
                                </div>
                                ...
                                <div className="flex justify-between items-center py-4 border-t border-gray-100">
                                    ...
                                    <span className="font-serif font-bold text-2xl text-primary-900">
                                        {(bookingType === 'vip' ? event.vip_price : event.regular_price) * quantity} Birr
                                    </span>
                                </div>
                            </div>
